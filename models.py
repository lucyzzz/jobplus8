...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:root@127.0.0.1/jobplus8'
db = SQLAlchemy(app)
...
# user1 = User(username='12dddd3', password="456",email="789",role="100") #创建用户
#
# jobseeker = jobseekerinfo(name="zs",sex=1,nativeplace="安徽",phone="123456",userid=2)#求职者编辑其信息
#
company = User(username='123', password="4562",email="erqrqwer",role="200") #创建用户
#
# company = companyinfo(company_name="SS",company_logo="pic/1.jpg",company_website="4399.com"\
#                   ,company_profile="1",company_address="2",company_details="3",companyid=1)
#
